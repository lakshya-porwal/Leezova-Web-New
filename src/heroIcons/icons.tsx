...
function ReactIcon({ className }: ReactIconProps) {
  return (
    <svg
...
function ReactQueryIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
function NextJsIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
function ReduxIcon({ className }: ReactIconProps) {
  return (
...
function ExpressJSIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="#000"
...
function FigmaIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
function GitIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
function GitHubIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
function HTMLIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
function JSIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
function FacebookIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
...
function InstagramIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
...
function LinkedInIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
...
function TwitterIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
      ...
      className={className}
    >
      <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2s9 5 20 5a9.5 9.5 0 00-9-5.5c4.75 2.25 9 5.5 9 5.5"></path>
    </svg>
  );
}

function XIcon({ className }: ReactIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      ...
      className={className}
    >
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.657l-5.207-6.807-5.967 6.807H2.882l7.432-8.529L1.237 2.25h6.846l4.713 6.231 5.416-6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
    </svg>
  );
}

function Arrow({ className }: ReactIconProps) {
  return (
    ...
    ><path d="M3.81 4.38 8 8.57l4.19-4.19 1.52 1.53L8 11.62 2.29 5.91l1.52-1.53z" /></svg>
  );
}
