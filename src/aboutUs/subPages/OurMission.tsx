      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            ...
            development solutions that drive growth and transformation. We are
            committed to delivering excellence in every project, combining
            cutting-edge technology with strategic thinking.
          </p>
          <p>
